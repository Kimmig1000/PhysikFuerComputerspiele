...
public class ModifyableQuader {
    ...
    public ModifyableQuader(MyGLBase1 vb, float m, float a, float b, float c) {
    	this(vb);
        this.m = m;
        this.a = a;
        this.b = b;
    ...
    public ModifyableQuader(MyGLBase1 vb) {
        this.vb = vb;
    }
    ...
    public void zeichne(GL3 gl, float a, float b, float c,   // Kantenlaengen
                        boolean gefuellt) {
        a *= 0.5f;
        b *= 0.5f;
        c *= 0.5f;
